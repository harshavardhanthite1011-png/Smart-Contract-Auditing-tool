...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      hash_pair(context, ...args_1) {
        return { result: pureCircuits.hash_pair(...args_1), context };
      }
    };
    this.impureCircuits = {};
...
export const pureCircuits = {
  hash_pair: (...args_0) => {
    if (args_0.length !== 2) {
      throw new __compactRuntime.CompactError(`hash_pair: expected 2 arguments (as invoked from Typescript), received ${args_0.length}`);
    }
    ...
    if (!(left_0.buffer instanceof ArrayBuffer && left_0.BYTES_PER_ELEMENT === 1 && left_0.length === 32)) {
      __compactRuntime.typeError('hash_pair',
                                 'argument 1',
                                 'HashHelper.compact line 4 char 1',
                                 'Bytes<32>',
                                 left_0)
    }
    ...
    return _dummyContract._hash_pair_0(left_0, right_0);
  }
};
